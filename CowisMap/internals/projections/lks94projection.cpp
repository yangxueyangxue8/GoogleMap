...
* @return
*******************************************************************************/
double LKS94Projection::GetTileMatrixResolution(const int &zoom)
{
    double ret = 0;
...
* @return
*******************************************************************************/
Point LKS94Projection::FromLatLngToPixel(double lat, double lng, const int &zoom)
{
    Point ret;
    lat = Clip(lat, MinLatitude, MaxLatitude);
    lng = Clip(lng, MinLongitude, MaxLatitude);
...
* @return
*******************************************************************************/
cowisinternals::PointLatLng LKS94Projection::FromPixelToLatLng(const int &x, const int &y, const int &zoom)
{
...
* @return
*******************************************************************************/
double LKS94Projection::GetGroundResolution(const int &zoom, const double &latitude)
{
    Q_UNUSED(latitude)
...
* @return
*******************************************************************************/
Size LKS94Projection::GetTileMatrixMinXY(const int &zoom)
{
    Size ret;
...
* @return
*******************************************************************************/
Size LKS94Projection::GetTileMatrixMaxXY(const int &zoom)
{
    Size ret;
...
double LKS94Projection::Clip(const double &n, const double &minValue, const double &maxValue)
{
