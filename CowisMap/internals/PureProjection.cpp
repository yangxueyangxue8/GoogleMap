...
{
    QList<Point> ret;
    Point topLeft = FromPixelToTileXY(FromLatLngToPixel(rect.LocationToLeft(), zoom));
...
* @return
*******************************************************************************/
double PureProjection::DistanceBetweenLatLng(const PointLatLng &p1, const PointLatLng &p2)
{
    double R    = 6371;
    double lat1 = p1.Lat();
    double lat2 = p2.Lat();
